...
export const Landing = () => {
    ...
    return (
        < div className='-z-10'>
            <div className='bg-gradient-to-b from-[#caf8a6] to-transparent h-[40rem] absolute top-0 left-0 right-0 -z-10'>
                <div className=' w-[50%] ml-[40%] text-left mt-48'>
                    <div className='pt-20 text-6xl mb-6 font-semibold'>Make Healthy Life with <span className='text-[#23aa48]'>Fresh Grocery Products</span></div>
            ...
            <img className='h-[40rem] ml-10' src={smilingwoman} alt="woman smiling" />
            <div className="container mx-auto py-8">
                <DisplayCard groceries={groceries} />
            </div>
            <div className="bg-gradient-to-tl from-transparent to-[#fff5dc] via-transparent h-[35rem] flex text-left px-24 pt-20">
                <div className='w-[40%] flex flex-col gap-6'>
                    ...
                    <Link to="/signup"><Button styles="px-4 py-2 bg-[#2fac51] text-white rounded-lg" title="Order Process" /></Link>
                </div>
                <div className='bg-[#f0bf01] p-10 ml-[15em] w-[30%] h-[20rem] rounded-t-full rounded-b-[20em] mb-[20rem]'>
                    <img className='absolute right-24 -mt-32' src={woman} alt="woman with groceries smiling" />
                </div>
            </div>
            <div>
                <div className='text-5xl font-bold'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit, nihil.</div>
                <div className="container mx-auto py-8">
                    <DisplayCard groceries={groceries} />
                </div>
            </div>
            <div className="bg-gradient-to-tr from-transparent to-[#fff5dc] via-transparent h-[35rem] flex text-left px-24 pt-20">
                <div className='bg-[#c0e8ac] p-10 mr-[15rem] w-[30%] h-[20rem] rounded-t-full rounded-b-[20em] mb-[20rem]'>
                    <img className='absolute -left-24 -mt-32' src={woman} alt="woman with groceries smiling" />
                </div>
                <div className='w-[40%]'>
                    <p className='text-4xl font-semibold'>
                        Best Quality Healhty and Fresh Groceries
                    </p>
                    ...
                    <Link to="/signup" className='bg-[#2fac51]'>Order Now</Link>
                </div>
            </div>
            <div className='p-5'>
                <div className='text-5xl'>What our customers say about us</div>
                <div className="container mx-auto py-8">
